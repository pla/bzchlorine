  ...
  for i, fb in pairs(data.raw["assembling-machine"]["assembling-machine-1"].fluid_boxes) do
    if i ~= "off_when_no_fluid_recipe" and fb.pipe_picture then
      ...
      if fb.pipe_picture.north.layers and fb.pipe_picture.north.layers[1] then
        fb.pipe_picture.north.layers[1].filename = "__bzchlorine__/graphics/entity/hr-assembler/assembling-machine-2-pipe-N.png"
        fb.pipe_picture.south.layers[1].filename = "__bzchlorine__/graphics/entity/hr-assembler/assembling-machine-2-pipe-S.png"
        fb.pipe_picture.east.layers[1].filename = "__bzchlorine__/graphics/entity/hr-assembler/assembling-machine-2-pipe-E.png"
        fb.pipe_picture.west.layers[1].filename = "__bzchlorine__/graphics/entity/hr-assembler/assembling-machine-2-pipe-W.png"
